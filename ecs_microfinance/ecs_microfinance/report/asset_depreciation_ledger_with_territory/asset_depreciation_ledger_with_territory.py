...
def get_data(filters):
    ...
    if filters.get("asset_category"):
        ...
        assets = frappe.db.sql_list(
            ...
            where asset_category = %s and docstatus=1 and workflow_state!="Cancelled" """,
    ...
    # Add the "Territory" filter
    if filters.get("territory"):
        assets_with_territory = frappe.db.sql_list(
            """select name from tabAsset
            where territory = %s and docstatus=1 and workflow_state!="Cancelled" """,
            filters.get("territory"),
        )

        filters_data.append(["against_voucher", "in", assets_with_territory])
